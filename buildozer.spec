...
requirements = python3,kivy,https://github.com/kivymd/KivyMD/archive/master.zip,signalslot,sqlalchemy
...
presplash.filename = kvgui/presplash.png

# (str) Icon of the application
#icon.filename = %(source.dir)s/data/icon.png
icon.filename = kvgui/icon.png
...
#p4a.local_recipes =
p4a.local_recipes = recipes/sqlalchemy
